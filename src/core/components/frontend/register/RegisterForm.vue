<template>
    ...
    <form>
        <div class="grid gap-y-4">
            <!-- Form Group -->
            <div>
                <label for="email" class="block text-sm mb-2">{{ t('Username') }}</label>
                <div class="relative">
            ...
            <div>
                <div class="flex justify-between items-center">
                    <label for="password" class="block text-sm mb-2">{{ t('ConfirmPassword') }}</label>
                </div>
                <div class="relative">
                    <input type="password" id="password" name="password"
                        class="py-3 px-4 block w-full border rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none"
            ...
            <div class="flex items-center">
                ...
                <div class="ms-3">
                    <p class="mt-2 text-sm text-gray-600">
                        {{ t('IAcceptThe') }}
                        <router-link :to="{ path: `/${locale}/register` }"
